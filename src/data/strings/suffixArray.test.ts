...
//     let pairs = [
//         [ "banana", [ 5, 3, 1, 0, 4, 2 ] ],
//         [ "yabbadabbado", [ 1, 6, 4, 9, 3, 8, 2, 7, 5, 10, 11, 0 ] ],
//         [ "aaaaa", [ 4, 3, 2, 1, 0 ] ]
//     ]
//     for ( let [ input, expected ] of pairs ) {
//         // console.log( "INPUT: " + input )
//         let actual = suffixArray( input as string )
...
test( "1", t => {
    ...
    // // let text = "chat-bhat-ahat-"
    // console.log()
    // let sa = suffixArray( text )
    // console.log( suffixArrayToString( sa, text ) )
    // console.log()
    // // let naiveSa = naiveSuffixArray( text )
    // // console.log( suffixArrayToString( naiveSa, text ) )
    // // console.log()
    t.pass()
} )
